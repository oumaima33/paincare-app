...
<c:forEach var="blog" items="${searchResults}">
     ...
     <div class="column">
	        <div class="blog-card">
	        	<img class="card-img-top" src="${pageContext.request.contextPath}${imagePath}"   onclick="showBlogDetails('${blog.id}','${pageContext.request.contextPath}${imagePath}', '${blog.titre}', '${blog.description}', '${blog.creation}')">	    
